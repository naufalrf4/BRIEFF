    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="alert alert-danger text-white" role="alert">
              Mohon maaf, pendaftaran film dimulai pada tanggal 15 Agustus 2022.
          </div>
        </div>
        <?php
        }
        ...
        <div class="col-lg-12">
            <div class="alert alert-danger text-white" role="alert">
              Mohon maaf, pendaftaran film telah ditutup.
          </div>
        </div>
        <div class="col-lg-12">
            <div class="card mb-4 pb-4">
                <div class="row m-4 mx-2 mt-3 mb-3">
                    <div class="col-lg-12 d-flex justify-content-between">
                        ...
                        <!--    <a href="<?= site_url('pendaftaran/add') ?>" class="btn btn-primary btn-sm mt-3"><i class="fas fa-plus fa-sm"></i> Daftar</a>-->
                        <!--</div>-->
                        <?php } ?>
                        <?php } } ?>
                                ...
                                foreach ($pendaftaran as $p) : ?>
                                    <tr>
                                        ...
                                        <td class="align-middle text-center">
                                            <?php if ($this->session->userdata('role') == 'admin') { ?>
                                                ...
                                                <?php } else { ?>
                                                    <?php if($p['status'] == '1') { ?>
                                                        ...
                                                        <form action="<?php echo site_url('pendaftaran/tolak/').$p['id']; ?>" method="post">
                                                            <input type="hidden" name="id" value="<?=$p['id']?>">
                                                            <button class="btn btn-sm btn-danger" id="tolak-pendaftaran">Batalkan Terima</button>
                                                        </form>
                                                    <?php } else if($p['status'] == '2') { ?>
                                                        <p><span class="btn-danger btn-sm badge-sm">Pendaftaran Ditolak</span></p>
                                                        <form action="<?php echo site_url('pendaftaran/terima/').$p['id']; ?>" method="post">
                                                            <input type="hidden" name="id" value="<?=$p['id']?>">
                                                            <button class="btn btn-sm btn-success" id="terima-pendaftaran">Batalkan Tolak</button>
                                                        </form>
                                            ...
                                            <?php } else if ($this->session->userdata('role') == 'kurator') { ?>
                                                ...
                                                <form action="<?php echo site_url('pendaftaran/lanjut-juri/').$p['id']; ?>" method="post">
                                                    <input type="hidden" name="id" value="<?=$p['id']?>">
                                                    <button class="btn btn-sm btn-success" id="terima-pendaftaran">Lanjut ke Juri</button>
                                                </form>
                                                <?php } else if($p['status'] == '2') { ?>
                                                ...
                                                <form action="<?php echo site_url('pendaftaran/batal-juri/').$p['id']; ?>" method="post">
                                                    <input type="hidden" name="id" value="<?=$p['id']?>">
                                                    <button class="btn btn-sm btn-danger" id="tolak-pendaftaran">Batalkan Lanjut ke Juri</button>
                                                </form>
                                                <?php } ?>
                                            <?php } else { ?>
                                                <?php if($p['status'] == '1') { ?>
                                                ...
                                                <?php } else if($p['status'] == '2') { ?>
                                                    <span class="badge bg-danger badge-sm">Pendaftaran Ditolak, <br> Silakan hubungi panitia.</span>
                                                <?php } else if($p['status'] == '0') { ?>
                                        ...
                                        <td class="align-middle text-center text-sm">
                                            <a href="<?= base_url('pendaftaran/detail/') . $p['id']; ?>" class="btn btn-sm btn-primary">Detail</a>
                                        </td>

                                        <td class="align-middle text-center text-sm">
                                            <?php if ($this->session->userdata('role') == 'admin') { ?>
                                                <a href="<?= base_url('pendaftaran/edit/') . $p['id']; ?>" class="btn btn-sm btn-success"><i class="fas fa-edit"></i></a>

                                                <a href="<?= base_url('pendaftaran/delete/') . $p['id']; ?>" class="btn btn-sm btn-danger" id="btn-hapus"><i class="fas fa-trash"></i></a>
                                            <?php } else if ($this->session->userdata('role') == 'kurator') { ?>
