            ...
            <div class="card mb-4 pb-4">
                <div class="row m-4 mx-2 mt-3 mb-3">
                    <div class="col-lg-12 d-flex justify-content-between">
                        <h5 class="text-left">Export Rekap Nilai</h5>
                        <div class="text-right">
                            <a href="<?=site_url('rekap-nilai')?>" class="btn btn-primary btn-sm mt-3">Kembali</a>
                        </div>
                    </div>
                </div>
                            ...
                            <tbody class="mb-4">
                                ...
                                foreach ($rekapnilai as $data) : ?>
                                    <tr>
                                        ...
                                        <td width="50px">
                                            <p class="text-xs font-weight-bold mb-0"><?= ucfirst($data->note) ?></p>
                                        </td>
                                        <td>
