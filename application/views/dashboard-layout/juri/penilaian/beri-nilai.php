            ...
            <div class="card mb-4 pb-4">
                <div class="row m-4 mx-2 mt-3 mb-3">
                    <div class="col-lg-12 d-flex justify-content-between">
                        <h5 class="text-left">Beri Penilaian <br>
                    ...
                    <form action="" method="post">
                        ...
                        <div class="row mb-2">
                            <div class="col-lg-6">
                                ...
                                <input type="number" name="teknik_penulisan" class="form-control" value="<?=set_value('teknik_penulisan') ?>" min="10" max="100">
                            ...
                            <div class="col-lg-6">
                                ...
                                <textarea name="desk_teknik_penulisan" class="form-control" value="<?=set_value('desk_teknik_penulisan') ?>"><?=set_value('desk_teknik_penulisan') ?></textarea>
                        ...
                        <div class="row mb-2">
                            <div class="col-lg-6">
                                ...
                                <input type="number" name="keutuhan_ide" class="form-control" value="<?=set_value('keutuhan_ide') ?>" min="10" max="100">
                                <small class="text-danger"><?=form_error('keutuhan_ide')?></small>
                            </div>
                            <div class="col-lg-6">
                                <label for="desk_keutuhan_ide">Deskripsi Keutuhan Ide</label>
                                <textarea name="desk_keutuhan_ide" class="form-control" value="<?=set_value('desk_keutuhan_ide') ?>"><?=set_value('desk_keutuhan_ide') ?></textarea>
                        ...
                        <div class="row mb-2">
                            <div class="col-lg-6">
                                ...
                                <input type="number" name="mimik" class="form-control" value="<?=set_value('mimik') ?>" min="10" max="100">
                                <small class="text-danger"><?=form_error('mimik')?></small>
                            </div>
                            <div class="col-lg-6">
                                <label for="desk_mimik">Deskripsi Mimik</label>
                                <textarea name="desk_mimik" class="form-control" value="<?=set_value('desk_mimik') ?>"><?=set_value('desk_mimik') ?></textarea>
                        ...
                        <div class="row mb-2">
                            <div class="col-lg-6">
                                ...
                                <input type="number" name="karakter" class="form-control" value="<?=set_value('karakter') ?>" min="10" max="100">
                                <small class="text-danger"><?=form_error('karakter')?></small>
                            </div>
                            <div class="col-lg-6">
                                <label for="desk_karakter">Deskripsi Karakter</label>
                                <textarea name="desk_karakter" class="form-control" value="<?=set_value('desk_karakter') ?>"><?=set_value('desk_karakter') ?></textarea>
                        ...
                        <div class="row mb-2">
                            <div class="col-lg-6">
                                ...
                                <input type="number" name="angel" class="form-control" value="<?=set_value('angel') ?>" min="10" max="100">
                                <small class="text-danger"><?=form_error('angel')?></small>
                            </div>
                            <div class="col-lg-6">
                                <label for="desk_angel">Deskripsi Angel</label>
                                <textarea name="desk_angel" class="form-control" value="<?=set_value('desk_angel') ?>"><?=set_value('desk_angel') ?></textarea>
                        ...
                        <div class="row mb-2">
                            <div class="col-lg-6">
                                ...
                                <input type="number" name="style" class="form-control" value="<?=set_value('style') ?>" min="10" max="100">
                                <small class="text-danger"><?=form_error('style')?></small>
                            </div>
                            <div class="col-lg-6">
                                <label for="desk_style">Deskripsi Style</label>
                                <textarea name="desk_style" class="form-control" value="<?=set_value('desk_style') ?>"><?=set_value('desk_style') ?></textarea>
                        ...
                        <div class="row mb-2">
                            <div class="col-lg-6">
                                ...
                                <input type="number" name="kualitas_gambar" class="form-control" value="<?=set_value('kualitas_gambar') ?>" min="10" max="100">
                                <small class="text-danger"><?=form_error('kualitas_gambar')?></small>
                            </div>
                            <div class="col-lg-6">
                                <label for="desk_kualitas_gambar">Deskripsi Kualitas Gambar</label>
                                <textarea name="desk_kualitas_gambar" class="form-control" value="<?=set_value('desk_kualitas_gambar') ?>"><?=set_value('desk_kualitas_gambar') ?></textarea>
                        ...
                        <div class="row mb-2">
                            <div class="col-lg-6">
                                ...
                                <input type="number" name="setting" class="form-control" value="<?=set_value('setting') ?>" min="10" max="100">
                                <small class="text-danger"><?=form_error('setting')?></small>
                            </div>
                            <div class="col-lg-6">
                                <label for="desk_setting">Deskripsi Setting & Property</label>
                                <textarea name="desk_setting" class="form-control" value="<?=set_value('desk_setting') ?>"><?=set_value('desk_setting') ?></textarea>
                        ...
                        <div class="row mb-2">
                            <div class="col-lg-6">
                                ...
                                <input type="number" name="makeup" class="form-control" value="<?=set_value('makeup') ?>" min="10" max="100">
                                <small class="text-danger"><?=form_error('makeup')?></small>
                            </div>
                            <div class="col-lg-6">
                                <label for="desk_makeup">Deskripsi Make Up & Costume</label>
                                <textarea name="desk_makeup" class="form-control" value="<?=set_value('desk_makeup') ?>"><?=set_value('desk_makeup') ?></textarea>
                        ...
                        <div class="row mb-2">
                            <div class="col-lg-6">
                                ...
                                <input type="number" name="style_editing" class="form-control" value="<?=set_value('style_editing') ?>" min="10" max="100">
                                <small class="text-danger"><?=form_error('style_editing')?></small>
                            </div>
                            <div class="col-lg-6">
                                <label for="desk_style_editing">Deskripsi Style Editing</label>
                                <textarea name="desk_style_editing" class="form-control" value="<?=set_value('desk_style_editing') ?>"><?=set_value('desk_style_editing') ?></textarea>
                        ...
                        <div class="row mb-2">
                            <div class="col-lg-6">
                                ...
                                <input type="number" name="penyutradaraan" class="form-control" value="<?=set_value('penyutradaraan') ?>" min="10" max="100">
                                <small class="text-danger"><?=form_error('penyutradaraan')?></small>
                            </div>
                            <div class="col-lg-6">
                                <label for="desk_penyutradaraan">Deskripsi Penyutradaraan</label>
                                <textarea name="desk_penyutradaraan" class="form-control" value="<?=set_value('desk_penyutradaraan') ?>"><?=set_value('desk_penyutradaraan') ?></textarea>
                                <small class="text-danger"><?=form_error('desk_penyutradaraan')?></small>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="note">Note</label>
                            <textarea name="note" class="form-control" value="<?=set_value('note') ?>"><?=set_value('note') ?></textarea>
